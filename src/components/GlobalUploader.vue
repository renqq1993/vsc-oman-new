<template>
    <div id="global-uploader">
        ...
        <uploader 
            ...
            <uploader-btn id="global-uploader-btn" :attr="attrs" ref="uploadBtn">选择文件</uploader-btn>
        </uploader>
    </div>
</template>
<script>
        ...
        onFileSuccess(rootFile, file, response, chunk) {
            ...
            if(res.status == 1){
                ...
                if (res.data.needMerge) {
                    ...
                    let responseData = {...data, name:res.data.name, fullPath:res.data.fullPath, type:"target"}
